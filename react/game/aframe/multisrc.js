...
AFRAME.registerComponent('multisrc', {
    ...
    materialListener: function() {
        ...
        this.el.addEventListener('componentchanged', this.compChange.bind(this));
    ...
    remove: function(){
      ...
      var animationEventsArray = ['animationbegin', 'animationstart', 'animationcomplete', 'animationend']
      for (const event of animationEventsArray) {
        this.el.addEventListener(event, this.materialChangedByAnimation.bind(this))
      };

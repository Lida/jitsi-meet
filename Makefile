...
WEBPACK = exec ./node_modules/.bin/webpack
WEBPACK_DEV_SERVER = exec ./node_modules/.bin/webpack-dev-server
...
source-package: compile deploy clean
	mkdir -p source_package/jitsi-meet/css && \
	cp -r *.js *.html _redirects assets connection_optimization favicon.ico fonts images libs static sounds LICENSE lang source_package/jitsi-meet && \
